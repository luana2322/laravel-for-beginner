...
<body>
    ...
    <p style="white-space:pre"> Don't have an account <a href="newuser.php" style="color: red; text-decoration: none">
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td> <input size="25" type="text" name="username" placeholder=" dhruv" autocomplete="off"
                                    required></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td> <input size="25" type="text" name="captcha" placeholder=" Enter captcha"
