...
<body>
    <p style="white-space:pre"> Already have an account <a href="login.php" title="Login"
            style="color: red;text-decoration: none"> Login </a> </p>
            ...
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td> <input type="text" name="captcha" placeholder=" Enter captcha" autocomplete="off" required>
                        </td>
                    </tr>
                    <tr>
